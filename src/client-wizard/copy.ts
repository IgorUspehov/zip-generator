...
const T: Record<UiLang, CopyBundle> = {
  en: {
    ...
    s6_h: "Your CRM Demo is ready",
    s6_dl: "Download your result",
    dl_domain: "Domain",
    s_processing_title: "Payment received — preparing your site",
    s_processing_sub: "Your payment was successful. We are publishing your CRM Demo. This usually takes under a minute.",
  ...
  de: {
    ...
    s6_pay_h: "CRM Demo freischalten",
    ...
    s6_h: "Ihr CRM Demo ist fertig",
    s6_dl: "Ergebnis herunterladen",
    dl_domain: "Domain",
    s_processing_title: "Zahlung erhalten — wir bereiten Ihre Seite vor",
    s_processing_sub: "Ihre Zahlung war erfolgreich. Wir veröffentlichen Ihr CRM Demo. Das dauert meist unter einer Minute.",
  ...
  ru: {
    ...
    s6_pay_h: "Откройте доступ к CRM Demo",
    ...
    s6_h: "Ваш CRM Demo готов",
    s6_dl: "Скачать результат",
    dl_domain: "Домен",
    s_processing_title: "Оплата прошла — готовим ваш сайт",
    s_processing_sub: "Оплата успешна. Мы публикуем ваш CRM Demo. Обычно это занимает меньше минуты.",
